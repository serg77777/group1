...
public class RobotControlPanel {
	...
	static class ControlBlock implements ComandListener {
	...
	// Ќовый поток считывающий данные с клавиатуры
	//
	private static void initKeyboardControl(final ComandListener commandListener) {

...
public class RobotControlPanel {
	...
	private static void visualize(Robot r2d2) {
		JFrame frame = new JFrame("Robot 2D example");
	...
	private static void initKeyboardControl(final CommandListener listener) {
	...
	private static void processCommnad(String command, Robot robot) {
		if (command == null) {
			return;
		}
		if (robot == null) {
			throw new IllegalArgumentException("no robots");
		}
